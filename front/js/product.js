// Chercher les paramètres de l'URL
let searchParams = new URLSearchParams(window.location.search);
let searchID = searchParams.get("id");

// Vérifier si l'URL a bien un ID
...
// Récupérer les données du produit en fonction de son ID
...
function addToCart() {
    ...
    addToCartBtn.addEventListener("click", () => {
        ...
        // Vérifier d'avoir choisi une couleur et que ça soit une valeur entre 1 et 100 quantités
